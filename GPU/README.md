...
sudo docker run --device=/dev/video0:/dev/video0 -v $(pwd)/TEST/:/Projects/NovaRecog/ -v /tmp/.X11-unix:/tmp/.X11-unix --volume="$HOME/.Xauthority:/root/.Xauthority:rw" -e DISPLAY=$DISPLAY -p 5000:5000 -p 8888:8888 --gpus all -w /Projects -it --entrypoint=/bin/bash --name=opencv-gpu opencv4.5.1:latest
